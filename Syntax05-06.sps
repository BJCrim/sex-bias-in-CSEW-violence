* Encoding: UTF-8.
cd "C:\Users\meshuser\Dropbox\Changing violence\data and syntax\05-06".

GET FILE='bcs_nvf_2005-6_to_esrc_with_rural2_income.sav'.
DATASET NAME DataSetnvf.
SORT CASES BY ROWLABEL.

COMPUTE SAMPYEAR=2005.
*  get the number of cases by sex.

GET FILE = 'csew_apr05mar06_nvf.sav' 
...
GET  FILE='bcs_victim_form_2005_6_to_esrc.sav' .
    
DATASET NAME DataSetvf.
SORT CASES BY match.
* and merget them together, keeping only useful values.

GET FILE 'csew_apr05mar06_vf.sav'.
...
EXECUTE.
SAVE OUTFILE='CSEW_05_06_VIOL.sav'/COMPRESSED.
