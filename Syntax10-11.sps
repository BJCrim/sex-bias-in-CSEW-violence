* Encoding: UTF-8.
cd "C:\Users\meshuser\Dropbox\Changing violence\data and syntax\10-11".

GET FILE='bcs_apr10mar11_nvf_core_variables.sav'.
DATASET NAME DataSetnvf.
SORT CASES BY ROWLABEL.

COMPUTE SAMPYEAR=2010.
*  get the number of cases by sex.

GET FILE = 'csew_apr10mar11_nvf.sav' 
...
EXECUTE.
SAVE OUTFILE='CSEW_10_11_VIOL.sav'/COMPRESSED.
