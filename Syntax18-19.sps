* Encoding: UTF-8.
cd "C:\Users\meshuser\Dropbox\Changing violence\data and syntax\18-19".
* open the non-victim form dataset.

GET FILE='csew_apr18mar19_nvf.sav'.
DATASET NAME DataSet2.
DATASET ACTIVATE DataSet2.
COMPUTE SAMPYEAR=2018.
...
GET  FILE='csew_apr18mar19_vf.sav'.
...
MATCH FILES /FILE=*
  ...
  /KEEP= ROWLABEL SEX AGE SAMPYEAR PINCID BEFOR99 SUSPEND SAMPTYPE YRINCIB WHERHAPP tocrfc_vf  VINTRO OFFENCE NSERIES NUMINC NUMBER NUMBER_UNCAPPED
             ...
             KNEWOFF SEENOFF NUMOFF C11INDIVWGT C11WEIGHTI  WEIGHTI_UNCAP. 
EXECUTE.
...
EXECUTE.
SAVE OUTFILE='CSEW_18_19_VIOL.sav'/COMPRESSED.
