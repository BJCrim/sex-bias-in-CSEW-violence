* Encoding: UTF-8.
cd "C:\Users\meshuser\Dropbox\Changing violence\data and syntax\16-17".
* open the non-victim form dataset.

GET FILE='csew_apr16mar17_nvf.sav'.
DATASET NAME DataSet2.
DATASET ACTIVATE DataSet2.
COMPUTE SAMPYEAR=2016.
...
GET  FILE='csew_apr16mar17_vf.sav'.
...
MATCH FILES /FILE=*
  ...
  /KEEP= ROWLABEL SEX AGE SAMPYEAR PINCID BEFOR99 SUSPEND SAMPTYPE YRINCIB WHERHAPP tocrfc_vf  VINTRO OFFENCE NSERIES NUMINC NUMBER NUMBER_UNCAPPED
             VIOLNR_VFNOCAP ALLASSAU_VF  VIOLNR_VF VIOLGRP  VIOLGRPNR  tocrfc_vf  tocrfc_vfnocap OFFREL3 OFFREL3A to OFFREL3Q KNEWOFF1 SEENOFF1 
             KNEWOFF SEENOFF NUMOFF C11INDIVWGT C11WEIGHTI . 
EXECUTE.

ATASET CLOSE Dataset2.
FILTER OFF.
USE ALL.
...
EXECUTE.
SAVE OUTFILE='CSEW_16_17_VIOL.sav'/COMPRESSED.
